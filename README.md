...
**Версия:** 1.0.1 | **Языки:** Русский, English
...
В версии 1.0.1 удалена функция "Перезапустить Bluetooth", которая могла приводить к отключению Bluetooth адаптера. Теперь программа предлагает безопасную перезагрузку системы для применения изменений AAC.
